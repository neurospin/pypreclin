...
edir= '/data/fmri_monkey_03/PROJECT/John/HighRes_Functional/rawdata/Nancy120806/'
cd(edir)

mc_undist_wouter2_20120524('cr_Nancy120806_run000*','cr_Nancy120806_gre3d_resamp_brain_mask.nii');
