...
edir= '/data/fmri_monkey_03/PROJECT/John/HighRes_Functional/rawdata/Nancy120815/'
cd(edir)

mc_undist_wouter2_20120524('cr_Nancy120815_run00012*','cr_Nancy120815_gre3d_brain_mask_resamp_adj.nii');
